...
const Category = (props) => {
    ...
    const displayCategory = category.map((categoryObj, index) => {
        ...
        return (
            ...
            <div className='jumbotron' id = {id} key = {index} style ={{float: 'top', display: 'inline-block', marginRight: '2.5em', padding: '0.7em'}}>
              <h1 className="display-3" style = {{ textAlign: 'center'}}>{title}</h1>
